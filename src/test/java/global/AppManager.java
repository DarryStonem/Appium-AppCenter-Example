...
public class AppManager {
    ...
    public static void startApp() {
        ...
        switch(platform){
            case ANDROID:
                app = new File(classpathRoot, "app/Android/com.myapp.app.apk");
            ...
            case IOS:
                ...
                if (envPlatform.equals("ios")){
                    app = new File(classpathRoot, "app/iOS/MyApp.ipa");
                }

                // Use .app for simulator
                if (envPlatform.equals("ios-simulator")) {
                    app = new File( "/Users/darrystonem/Desktop/MyApp.iOS.app");
                }
